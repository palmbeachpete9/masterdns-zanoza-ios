...
// generated by Slipstream's ConfigBuilder (kept in sync manually).
const sampleTOML = `
...
SOCKS5_AUTH = false
SOCKS5_USER = "slipstream"
SOCKS5_PASS = "slipstream"
...
// Validates that a TOML payload shaped exactly like the one Slipstream's
// Swift ConfigBuilder emits is accepted by MasterDnsVPN's loader, including
// resolver discovery via the runtime directory.
func TestSlipstreamGeneratedConfigLoads(t *testing.T) {
	dir := t.TempDir()
